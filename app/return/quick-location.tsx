...
export default function QuickLocationScreen() {
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        <View style={styles.instructionCard}>
          ...
          <Text style={styles.instruction}>Name where you are right now.</Text>
          <Text style={styles.instructionSub}>
            Say it out loud.{'\n'}
            The city, the room, the building.{'\n'}
